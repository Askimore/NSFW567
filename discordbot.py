...
async def on_ready():
    ...
    activity_w = discord.Activity(type=discord.ActivityType.streaming, name="吹妳老公的大雞巴", url="https://cdn.discordapp.com/attachments/856925480192311307/883036888305397810/ezgif-2-e44b0f4de4b1.gif")
